// PawCare Registration Form JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-save to session storage (if needed)
    function autoSave() {
        ...
        inputs.forEach(input => {
            input.addEventListener('input', function() {
                ...
                // but as per instructions, we're not using browser storage
                console.log('Auto-saving form data...', formData);
            });
        });
    }

    // Uncomment if auto-save is needed
    // autoSave();

    console.log('PawCare Registration Form initialized successfully!');
});

document.addEventListener("DOMContentLoaded", () => {
    const scrollBtn = document.getElementById("scrollTopBtn");

    // Mostrar el botón solo cuando se baja más de 200px
    ...
    // Al hacer clic, volver al inicio con efecto suave
